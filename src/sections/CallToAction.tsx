...
export const CallToAction = () => {
  ...
  const [mouseX, mouseY] = useRelativeMousePosition(searchDivRef);
    ...
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        >
          ...
          ></div>
          <motion.div
            className="absolute inset-0 bg-[rgb(74,32,138)] bg-blend-overlay [mask-image:] opacity-0 group-hover:opacity-100 transition duration-700"
            style={{
              maskImage,
              backgroundImage: `url(${gridLines.src})`,
            }}
