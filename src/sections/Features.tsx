    ...
    >
      {props.selected && (
        <motion.div
          ...
          ref={borderRef}
          className="absolute inset-0 border border-[#A369FF] rounded-xl"
        ></motion.div>
      )}
    ...
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto tracking-tight text-center mt-5">
          ...
          revolutionise the way business approach Search.
        </p>
        ...
        <div className="border border-white/20 p-2.5 rounded-xl mt-5">
          <motion.div
